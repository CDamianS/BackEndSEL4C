...
urlpatterns = [
    ...
    path(
        "respuestas_cuestionarioI",
        views.repuestas_cuestionarioI,
        name="repuestas_cuestionarioI",
    ),
    path(
        "respuestas_cuestionarioF",
        views.repuestas_cuestionarioF,
        name="repuestas_cuestionarioF",
    ),
